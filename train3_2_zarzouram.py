...
if __name__ == "__main__":
    ...
    # ================================= TRAIN =====================================                             
    parser.add_argument("--ckpt_path", help="Checkpoint location", default= "./ckpt_huge_embed_2048_no_paddiqng_embed") 
    # patch 越小越強
    parser.add_argument("--model_option",  default= "vit_huge_patch14_224_clip_laion2b") #"vit_base_resnet50_384"  "vit_large_patch14_224_clip_laion2b" "vit_base_patch8_224"
